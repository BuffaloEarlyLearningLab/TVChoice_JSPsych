document.addEventListener('DOMContentLoaded', function() {
    ...
    let audioFiles = [
        {src: 'components/audio_files/F5_karve.wav', label: 'karve'},
        {src: 'components/audio_files/F5_kiskis.wav', label: 'kiskis'},
        {src: 'components/audio_files/F5_knyga.wav', label: 'knyga'},
        {src: 'components/audio_files/F5_medis.wav', label: 'medis'},
        {src: 'components/audio_files/F5_meska.wav',label: 'meska'},
        {src: 'components/audio_files/F5_namas.wav', label: 'namas'},
        {src: 'components/audio_files/F5_raktas.wav', label: 'raktas'},
        {src: 'components/audio_files/F5_tigras.wav', label: 'tigras'},
        {src: 'components/audio_files/F5_tortas.wav', label: 'tortas'},
        {src: 'components/audio_files/F5_vista.wav', label: 'vista'},
        {src: 'components/audio_files/F5_voras.wav', label: 'voras'},
        {src: 'components/audio_files/M5_karve.wav', label: 'karve'},
        {src: 'components/audio_files/M5_kiskis.wav', label: 'kiskis'},
        {src: 'components/audio_files/M5_knyga.wav', label: 'knyga'},
        {src: 'components/audio_files/M5_medis.wav', label: 'medis'},
        {src: 'components/audio_files/M5_meska.wav', label: 'meska'},
        {src: 'components/audio_files/M5_namas.wav', label: 'namas'},
        {src: 'components/audio_files/M5_raktas.wav', label: 'raktas'},
        {src: 'components/audio_files/M5_tigras.wav', label: 'tigras'},
        {src: 'components/audio_files/M5_tortas.wav', label: 'tortas'},
        {src: 'components/audio_files/M5_vista.wav', label: 'vista'},
        {src: 'components/audio_files/M5_voras.wav', label: 'voras'}
    ];
    ...
    function handleImageClick(event) {
        ...
        setTimeout(() => {
            if (currentAudioIndex < audioFiles.length - 1) {
				...
				jatos.endStudyAndRedirect("https://buffalocas.co1.qualtrics.com/jfe/form/SV_3C08ME0aWnA5cz4?id=" + jatos.studySessionData.id);
            }
        }, 2000);
    }
