document.addEventListener('DOMContentLoaded', function() {
    ...
    indices.forEach(function(index) {
        ...
        //         html += '<div class="center-image"><img src="components/pictures/wave.jpg" alt="Wave"></div>';
		// 		html += '<div class="window.playAudio('${audioFiles[spIndex]}')"></div>';
        //         html += '</div>';
        //         return html;
        //     },
        //     choices: "NO_KEYS",
		...
		// var image_only_trial = {
		// 	type: "audio-keyboard-response",
		// 	stimulus: speaker.audio,
		// 	prompt: function(){
		// 	  return '<div class="center-image"><img src="components/pictures/wave.jpg" alt="Wave"></div>'},
		// 	trial_duration: 1000,
		...
		// 	}
		// };
		// timeline.push(image_only_trial);
